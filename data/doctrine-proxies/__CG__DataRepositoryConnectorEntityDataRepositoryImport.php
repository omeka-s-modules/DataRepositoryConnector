 ...
 */
class DataRepositoryImport extends \DataRepositoryConnector\Entity\DataRepositoryImport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DataRepositoryImport $proxy) {

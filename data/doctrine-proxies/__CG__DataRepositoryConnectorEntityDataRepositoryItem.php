...
namespace DoctrineProxies\__CG__\DataRepositoryConnector\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class DataRepositoryItem extends \DataRepositoryConnector\Entity\DataRepositoryItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'item', 'job', 'uri', 'lastModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DataRepositoryItem $proxy) {
